...
const MostPopularAds: React.FC<MostPopularAdsProps> = ({ ADSList }) => {
  ...
  return ( 
   ...
   <Box className ={'grid'}>
     <Box  className ={'main  card'}  sx={{ height: '100%' , borderRadius :"25px"  ,position :"relative"}}>
        <img
            style={{
            width: '100%',
             height: '100%',
        ...
        alt="RoomPicture"
          />
                <Box sx={{width : {xs :"32%"  ,md :"42%",  lg :"36%",  xl :"25%" , 
          
        } , position:"absolute"  , top : "0%" , left :{xs :"67%", md :"58%",lg:"64%", xl:"75%"
           
        } , color :"whitesmoke"  , backgroundColor :"#FF498B" , px:1  , borderTopRightRadius :"25px" , borderBottomLeftRadius :"25px"}}   variant="body1" color="initial">
             <Typography  sx={{fontSize :11, py : {
              md :"10px"
             }} }>
        ...
        <Box  className ={'card'} sx={{ height: '100%' , width:'100%' , borderRadius :"25px" , position:"relative"}}>
           <img
             style={{
               width: '100%',
               height: '100%',
